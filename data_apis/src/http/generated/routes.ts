...
const models: TsoaRoute.Models = {
    ...
    "DatasetType": {
        "dataType": "refAlias",
        "type": {"dataType":"union","subSchemas":[{"dataType":"enum","enums":["esg"]},{"dataType":"enum","enums":["housing"]},{"dataType":"enum","enums":["shopping_centre"]},{"dataType":"enum","enums":["school_enrolment"]},{"dataType":"enum","enums":["transport_facility"]},{"dataType":"enum","enums":["distinguished_achiever"]},{"dataType":"enum","enums":["crime"]},{"dataType":"enum","enums":["abs_census"]},{"dataType":"enum","enums":["aus_population"]},{"dataType":"enum","enums":["aus_gdp"]}],"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "AggregationType": {
        "dataType": "refAlias",
